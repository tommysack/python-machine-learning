...
for k in range(1, 11):
  ...
  #It creates k clusters (than k centroids), the algorithm will run 10 times with different centroid, and each of these will iterate a maximum of 2000 times to converge
  kmeans = KMeans(n_clusters=k, init='k-means++', n_init= 10, max_iter=2000)    
  kmeans.fit(X)
  ...
  print("Label classification of points: ", Y_pred)
  print("----------------------------")
