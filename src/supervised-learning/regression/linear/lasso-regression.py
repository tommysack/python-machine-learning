...
Anyway I would try with Lasso and all features.
'''
...
The "best": in this case we use Lasso.
It imposes a penalty on coefficients with L1 regularization.
'''
...
lasso = Lasso(
  alpha=1, #Constant that multiplies the L1 regularization to avoid overfitting
) 
