...
It make a probabilistic (returns the probability between 0 and 1 that a point belongs to a class using sigmoid function) 
binary (but is possible multi-class one vs all) linear classifier. 
'''
